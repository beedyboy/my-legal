...
const CartTotal = ({total, open, toggle, count, emptyCart, checkout, sending, ckclose, toggleCKClose}) => {
    const sendCart = e => {
      e.preventDefault()
      toggle(true);
    }
    ...
    return (
        <Fragment>
            ...
            <span className="pull-right">
                    <Button type="button" color="danger" onClick={(e) => clearCart(e)} disabled={count < 1}>Empty Cart</Button>
                </span>
