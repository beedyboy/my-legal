      ...
      <Card className='mt-2'>
         ...
         <Row>
           ...
           <Col md="12" sm="12" className='mt-2'>
             <AdminTicketList  data={tickets} setMode={setMode} toggle={handleClose} removeData={removeTicket} rowData={setRowData} /> 
           </Col>
         </Row>  
         <TicketForm mode={mode} open={modal} handleClose={handleClose} initial_data={rowData} />  
